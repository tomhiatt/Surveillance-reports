...
##### `r I(pasteLabel("Figure", figCount, "f.estxy", insLink=FALSE))`. Estimated proportion of MDR-TB among new and retreatment cases, `r yr`
...
##### `r I(pasteLabel("Figure", figCount, "f.expend", insLink=FALSE))`. Trend of expenditure (line) and funding received (bars) for MDR-TB in countries of the Western Pacific Region, 2007`r paste0("\u2013", yr)`
Graph showing notification and enrolment
