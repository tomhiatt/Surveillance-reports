---
title: 'Epidemiology and control of tuberculosis in the Western Pacific Region: analysis
  of case notification data in `r yr <- 2013; yr`'
...
lapply(c("reshape", "plyr", "dplyr", "ggplot2", "grid", "scales", "xtable", "stringr", "ggthemes"), library, character.only=TRUE)
#timeSeries is messing things up...I'm not sure what I need it for. , "timeSeries"
...
notb$`New lab-confirmed` <- ifelse(notb$year < 2013, notb$new_sp / notb$e_pop_num * 1e5, notb$new_labconf / notb$e_pop_num * 1e5)
notc <- melt(notb[c("year", "New lab-confirmed", "All forms of TB")], id=1)
