---
title: 'Epidemiology and control of tuberculosis in the Western Pacific Region: update with 2013 case notification data'
...
In `r yr`, countries and areas in the Western Pacific Region (n=36) reported `r n1` people with TB disease (`r I(pasteLabel("Table", tableCount, "t-notif"))`), making up `r n2`% of the global burden. Of these, `r n3`% (`r n4` cases) were either new or relapse TB cases. Within the Region, China accounted for `r n5`% (`r n6` cases) of the caseload followed by the Philippines and Viet Nam with `r n7`% (`r n8` cases) and `r n9`% (`r n10` cases), respectively. TB notification rates in `r yr`, expressed as cases per 100 000 person years [PYs], varied substantially in the Region with the highest rates (`r "\u2265"` 200  per 100 000 PYs) found in `r n12`  with `r n13` per 100 000 PYs, respectively (`r I(pasteLabel("Figure", figCount, "m-notif"))`). 
