...
**`r I(pasteLabel("Figure", figCount, "f-notif-trend", insLink=FALSE))` Tuberculosis case notification rate (all forms and new bacteriologically confirmed^a^) per 100 000 population in the Western Pacific Region, `r min(notc$year)`--`r max(notc$year)`**  
...
``` {r f-agesex-b, warning=FALSE, fig.height=10, fig.width=4}
age.b
```
...
Overall speaking, TB treatment success in the Region continues to be over 85% (`r I(pasteLabel("Figure", figCount, "f-txout-line"))`), a trend observed since  1997. Across the Region, `r n31` countries and areas reached or maintained 85% treatment success. Among the countries with a high burden of TB, treatment success was highest in `r n32[1,1]` (`r n32[1,3]`%) followed by `r n32[2,1]` (`r n32[2,3]`%), `r n32[3,1]` (`r n32[3,3]`%), `r n32[4,1]` (`r n32[4,3]`%), `r n32[5,1]` (`r n32[5,3]`%) and `r n32[6,1]` (`r n32[6,3]`%). The treatment success rate of `r n32[7,1]` was the lowest at `r n32[7,3]`% with `r n33` of the `r yr-1` cohort either lost to follow-up or un-evaluated. The proportion of notified cases that were not reported as being put on treatment was highest in `r n35c` with `r n35n` percent, respectively. 

--------------------------------------------------------

<a id="f-txout-line"></a> 
**`r I(pasteLabel("Figure", figCount, "f-txout-line", insLink=FALSE))` Trend of treatment success among new bacteriologically confirmed cases in select countries of the Western Pacific Region, `r min(trd$year)`--`r max(trd$year)`**  
