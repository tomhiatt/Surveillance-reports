...
### Introduction
Since the year 2000, tuberculosis (TB) prevalence in the World Health Organization (WHO) Western Pacific Region decreased `r a1` percent. There are estimated `r a4[2]/1e6` million TB cases with `r a5` deaths every year. This study describes a regional analysis using the WHO global TB database data from 2000--`r yr`. 
