...
', d[[col]]))))
  ...
  if(ord %nin% c('wpr')) warning('Not ordering.')
...
write.csv(tbm, file=paste0(pasteLabel("D:/Users/hiattt/Dropbox/Code/Surveillance reports/figure data/table", tableCount, "t-notif", insLink=FALSE), ".csv"), row.names=FALSE, na="")
```
